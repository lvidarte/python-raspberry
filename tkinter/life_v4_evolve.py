...
class Game(tk.Frame):
    ...
    def create_events(self):
        ...
        self.canvas.bind_all('<space>', self.evolve)
    ...
    def draw(self):
        self.clear()
        for cell in self.life.get_alive_cells():
            self.draw_cell(cell)
